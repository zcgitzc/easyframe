package com.zark.easyframe.mybatis.plugin;
...
public class MyBatisPaginationPlugin extends PluginAdapter implements CommentGenerator {
	...
	public List<GeneratedXmlFile> contextGenerateAdditionalXmlFiles(IntrospectedTable introspectedTable) {
		...
		GeneratedXmlFile gxf = new GeneratedXmlFile(document, fileNameExt, introspectedTable.getMyBatis3XmlMapperPackage(), context.getSqlMapGeneratorConfiguration().getTargetProject(), false,
	...
	public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
		...
		GeneratedJavaFile generatedJavaFile = new GeneratedJavaFile(compilationUnits, context.getJavaModelGeneratorConfiguration().getTargetProject(),
	...
	@Override
	public void addFieldComment(org.mybatis.generator.api.dom.java.Field field, IntrospectedTable introspectedTable, IntrospectedColumn introspectedColumn) {
		if (suppressAllComments) {
			return;
		}
	...
	public static void main(String[] args) {
		String config = MyBatisPaginationPlugin.class.getClassLoader().getResource("generatorConfig-conf.xml").getFile();
		String[] arg = { "-configfile", config, "-overwrite" };
		ShellRunner.main(arg);
		
		String config2 = MyBatisPaginationPlugin.class.getClassLoader().getResource("generatorConfig-common.xml").getFile();
